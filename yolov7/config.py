...
def add_yolo_config(cfg):
    ...
    # random flip
    _C.INPUT.RANDOM_FLIP_HORIZONTAL = CN()
    _C.INPUT.RANDOM_FLIP_HORIZONTAL.ENABLED = True
    _C.INPUT.RANDOM_FLIP_HORIZONTAL.PROB = 0.5
    _C.INPUT.RANDOM_FLIP_VERTICAL = CN()
    _C.INPUT.RANDOM_FLIP_VERTICAL.ENABLED = True
    _C.INPUT.RANDOM_FLIP_VERTICAL.PROB = 0.5
